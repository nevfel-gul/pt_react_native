...
import {
      ...
      <View style={styles.headerWrapper}>
        <View style={styles.headerTopRow}>
          <View style={styles.leftHeaderArea}>
            ...
            {/* Search */}
            {!searchActive && (
              <TouchableOpacity onPress={openAnimatedSearch}>
          ...
          <View style={styles.rightHeaderArea}>
            <TouchableOpacity onPress={() => setNotifOpen(!notifOpen)}>
  ...
  style={[
    styles.filterBox,
    { backgroundColor: "#1E3A8A", borderColor: "rgba(59,130,246,0.6)" },
...
<TouchableOpacity
  ...
  style={[
    styles.filterBox,
    { backgroundColor: "#B45309", borderColor: "rgba(251,191,36,0.6)" },
